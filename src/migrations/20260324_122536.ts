...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'premium', 'registered');
  CREATE TYPE "public"."enum_users_subscription_status" AS ENUM('active', 'cancelled', 'none');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_events_status" AS ENUM('upcoming', 'past', 'cancelled');
  CREATE TYPE "public"."enum_registrations_payment_status" AS ENUM('paid', 'free', 'pending');
  CREATE TYPE "public"."enum_subscribers_source" AS ENUM('newsletter', 'event', 'premium');
  ...
  CREATE TABLE "users" (
  	...
  	"name" varchar,
  	"role" "enum_users_role" DEFAULT 'registered',
  ...
  CREATE TABLE "subscribers" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"email" varchar NOT NULL,
  	"source" "enum_subscribers_source" DEFAULT 'newsletter',
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'AHA Software',
  	"site_description" varchar DEFAULT 'Technology consulting for the modern enterprise.',
  	"contact_email" varchar DEFAULT 'roger@ahasw.com',
  ...
  ALTER TABLE "events" ADD CONSTRAINT "events_recording_id_media_id_fk" FOREIGN KEY ("recording_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "events_recording_idx" ON "events" USING btree ("recording_id");
